...
closed_data=pd.read_csv("C:\\Users\\goomb\\Documents\\Datasets\\FinancialRiskManagement\\Assignment2\\CloseData.csv")
...
print("\nPodemos ver que el diversificado es menor lo cual tiene sentido porque el VaR no diversificado\n", 
"es equivalente a calcular el no diversificado cuando toda las correlacions son 1")
